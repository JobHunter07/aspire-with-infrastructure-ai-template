...
## Project Guidelines
- Prefer file-scoped namespaces for C# files (use declarations like: "namespace GatewayHost.Modules.Bff;") across the repository.
...
Notes:
- This is a repository-level preference. If a file-level exception is required, document the exception in the same folder's README.File-scoped Namespace Preference
